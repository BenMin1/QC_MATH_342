...
relevant_data[relevant_data$full_address_or_zip_code == "78-07 Springfield Blvd,  Bayside NY, 1136",6] = "11364"

relevant_data[relevant_data$full_address_or_zip_code == "32-42 89th St,  E. Elmhurst NY, 1136",6] = "11369"

relevant_data[relevant_data$full_address_or_zip_code == "35-25 77 St,  Jackson Heights NY, 1137",6]= "11372"

relevant_data[relevant_data$full_address_or_zip_code == "34-30 78th St,  Jackson Heights NY, 1137",6] = "11372"

relevant_data[relevant_data$full_address_or_zip_code == "61-20 Grand Central Pky,  Forest Hills NY, 1137",6] = "11375"

relevant_data[relevant_data$full_address_or_zip_code == "42-42 Colden Street,  Flushing NY, 11355 (Active )",6] = "11355"

relevant_data[relevant_data$full_address_or_zip_code == "80-35 Springfield Blvd,  Queens Village NY, 1142",6] = "11427"

relevant_data[relevant_data$full_address_or_zip_code == "138-35 Elder Ave,  Flushing NY, 1135",6] = "11355"
...
relevant_data$full_address_or_zip_code = str_sub(relevant_data$full_address_or_zip_code, start = -5)
...
{r}
relevant_data = dummy_cols(relevant_data, select_columns = c("full_address_or_zip_code"), remove_first_dummy = TRUE, remove_selected_columns = TRUE)
...
#set imputed values to their respectuve indices
